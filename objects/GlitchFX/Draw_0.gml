...
var _targetTimestepSize = 0.002;
ballTimestep += (_targetTimestepSize - ballTimestep) * 0.05;
ballTime += ballTimestep;
var _ballAxisFunctions = [ballTime, 1.5 * ballTime + .25];
_ballPosition = [(abs((_ballAxisFunctions[0] % 2.) - 1)) * (room_width - 16) + 4, (abs((_ballAxisFunctions[1] % 2.) - 1)) * (room_height - 16) + 4];
...
draw_sprite_ext(sprVortex, image_index,_ballPosition[0], _ballPosition[1] , 3, 3, 0, c_white, 1);