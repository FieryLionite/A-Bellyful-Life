/// @description add_dropdown_option(array_position, main icon, option text, action icon, add optional separator)
/// @param array_position
/// @param  main icon
/// @param  option text
/// @param  action icon
/// @param  add optional separator
function add_dropdown_option(argument0, argument1, argument2, argument3, argument4) {
